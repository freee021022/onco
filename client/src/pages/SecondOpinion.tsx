...
const SecondOpinion = () => {
  ...
  const verifiedDoctors = doctors?.filter(doctor => doctor.isDoctor && doctor.isVerified) || [];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row mb-16">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-12">
              <img 
                src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80" 
